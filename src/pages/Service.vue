  ...
  <div class="min-h-screen bg-white">
      ...
      <div class="mx-auto max-w-6xl">
        <div class="flex flex-col gap-8 animate-fade-in">
          ...
          <p class="text-xl text-gray max-w-2xl animate-slide-down" style="animation-delay: 0.1s">
            We offer a comprehensive suite of digital marketing services designed to help your business succeed online.
          </p>
        </div>
      </div>
    </section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="space-y-2">
              ...
              <ul class="space-y-2">
                <li v-for="feature in service.features" :key="feature" class="text-sm text-gray flex items-center gap-2">
                  <span class="w-1.5 h-1.5 rounded-full bg-primary"></span>
                  {{ feature }}
                </li>
              </ul>
            </div>
            <button class="mt-8 w-full rounded-[50px] bg-dark text-white py-3 font-semibold hover:bg-dark/90 transition transform hover:scale-105 active:scale-95">
              Learn More
            </button>
          </div>
        </div>
    ...
    <section class="bg-dark px-5 md:px-20 py-20 animate-fade-in">
      <div class="mx-auto max-w-4xl text-center">
        ...
        <button class="rounded-[50px] bg-primary text-dark px-8 py-4 font-bold hover:bg-primary/90 transition transform hover:scale-105 active:scale-95">
          Get Started Today
        </button>
      </div>
    </section>
