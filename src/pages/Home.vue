...
const faqs = [
  ...
  },
  {
    ...
    answer: "Through SEO optimization, content marketing, social media engagement, and paid advertising campaigns, we can significantly improve your website's visibility across search engines and social platforms."
  },
  {
    question: "How long does it take to see results from digital marketing efforts?",
    answer: "Results vary depending on the strategy, but typically you can see initial improvements within 3-6 months, with more substantial results after 6-12 months of consistent effort."
  },
  {
    question: "How do you measure the success of digital marketing campaigns?",
    answer: "We use various metrics including traffic, conversions, ROI, engagement rates, and other KPIs tailored to your specific business goals."
  }
]

// Categories for case studies
const categories = ref(['All Work [30]', 'Local Dining [04]', 'Digital Marketing [8]', 'Branding [4]'])
...
<template>
  <div class="min-h-screen bg-white">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div class="flex flex-col justify-center gap-12 animate-fade-in">
            <div class="flex flex-col gap-8">
              <h1 class="text-5xl font-semibold leading-[110%] tracking-[-0.03em] text-dark md:text-6xl lg:text-[72px] animate-slide-down">
                Stay ahead of the curve with our forward-thinking
              </h1>
              <p class="max-w-[557px] text-base font-medium leading-[180%] text-gray animate-slide-down" style="animation-delay: 0.1s">
            ...
            <div class="flex flex-wrap items-center gap-8 md:gap-14 animate-slide-down" style="animation-delay: 0.2s">
              <button class="group flex items-center gap-3 rounded-[50px] bg-dark px-6 py-4 transition hover:bg-dark/90 hover:scale-105 active:scale-95">
                <span class="font-manrope text-base font-bold leading-[140%] tracking-tight text-white">Explore us</span>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="transition group-hover:translate-x-1">
                  <path d="M5 12H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12 5L19 12L12 19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
              <button class="text-base font-semibold leading-[180%] text-dark underline transition hover:text-gray hover:scale-105">
                View Case Study
              </button>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-8 md:gap-16 animate-slide-down" style="animation-delay: 0.3s">
              ...
              <div class="flex items-center gap-7 opacity-50">
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/e7d50ae8a200300f69e8831be4c3ff9b006e51cd" alt="Company logo" class="h-8 w-auto hover:opacity-100 transition" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/e7d50ae8a200300f69e8831be4c3ff9b006e51cd" alt="Company logo" class="h-8 w-auto hover:opacity-100 transition" />
                <img src="https://api.builder.io/api/v1/image/assets/TEMP/e7d50ae8a200300f69e8831be4c3ff9b006e51cd" alt="Company logo" class="h-8 w-auto hover:opacity-100 transition" />
              </div>
            </div>
          ...
          <div class="relative flex flex-col justify-center gap-8 animate-slide-up">
            ...
            <div class="flex flex-col gap-8 md:flex-row md:items-start">
              <div class="w-full rounded-[20px_20px_20px_1000px] bg-gray-lighter/60 p-6 backdrop-blur-[42px] md:w-[303px] hover:shadow-lg transition">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a" alt="" class="h-auto w-full rounded-[1000px_20px_20px_20px]" />
              </div>
              
              <div class="relative w-full rounded-[20px] bg-gray-lighter/60 p-6 backdrop-blur-[42px] md:w-[259px] hover:shadow-lg transition">
                <div class="flex flex-col gap-8">
                  <h2 class="text-[84px] font-bold leading-[150%] tracking-[-0.03em] text-dark">230+</h2>
            ...
            <div class="relative overflow-hidden rounded-[20px] bg-dark p-8 hover:shadow-xl transition transform hover:scale-105">
              ...
              <div class="absolute right-4 top-4 flex h-[108px] w-[108px] items-center justify-center rounded-full bg-dark shadow-[0_30px_50px_-7px_rgba(0,0,0,0.3)] animate-pulse">
            ...
            <!-- 920+ card -->
            <div class="absolute -bottom-12 left-0 hidden rounded-[20px] bg-dark p-8 md:block lg:-bottom-20 animate-bounce-slow">
              <div class="flex flex-col gap-6">
                <h2 class="text-6xl font-bold leading-[150%] tracking-[-0.03em] text-white lg:text-[84px]">920+</h2>
                <p class="max-w-[200px] text-sm font-medium leading-[150%] text-white">
                  Projects that were successfully
                </p>
                <div class="flex items-center gap-2">
                  <div class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"></div>
                  <div class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"></div>
                  <div class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"></div>
                  <div class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"></div>
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div class="rounded-[20px] bg-dark p-8 md:hidden lg:block hover:shadow-xl transition">
            <div class="flex flex-col gap-6">
              ...
              <div class="flex items-center gap-2">
                <div class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"></div>
                <div class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"></div>
                <div class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"></div>
                <div class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"></div>
                <span class="text-5xl font-bold text-white">+</span>
          ...
          <div class="relative overflow-hidden rounded-[30px] hover:shadow-2xl transition group">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a" alt="" class="h-auto w-full object-cover group-hover:scale-110 transition duration-500" />
            ...
            <button class="absolute bottom-8 right-8 flex h-[163px] w-[163px] items-center justify-center rounded-full border-[12px] border-[#FAFAFA] bg-primary transition hover:scale-110 active:scale-95 shadow-xl group-hover:shadow-2xl">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M39.2498 17.1472C40.1304 17.6155 40.8669 18.3145 41.3805 19.1693C41.8942 20.0242 42.1655 21.0027 42.1655 22C42.1655 22.9973 41.8942 23.9759 41.3805 24.8307C40.8669 25.6856 40.1304 26.3846 39.2498 26.8529L15.7611 39.6257C11.979 41.6827 7.33331 39.006 7.33331 34.7747V9.2272C7.33331 4.9922 11.979 2.31737 15.7611 4.37253L39.2498 17.1472Z" fill="black"/>
              </svg>
            </button>
          </div>
        </div>
    ...
    <section class="bg-[#FAFAFA] px-4 py-16 md:px-5 md:py-20">
      <div class="mx-auto rounded-[30px] bg-dark px-8 py-16 md:px-16 md:py-20 animate-fade-in">
        <div class="flex flex-col items-center gap-14">
          <h2 class="max-w-[1280px] text-center text-3xl font-semibold leading-[130%] tracking-tight text-white md:text-4xl lg:text-5xl">
          ...
          <div class="flex flex-wrap justify-center gap-3">
            <button 
              ...
              :class="[
                ...
                index === 1 ? 'bg-primary text-dark' : 'border border-white/30 text-white hover:bg-white/10'
              ]"
            >
              {{ category }}
            </button>
          ...
          <div class="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative animate-fade-in hover:scale-105 transition">
              <div class="overflow-hidden rounded-[261px] border-[11px] border-white/40 backdrop-blur-[67px] hover:border-white/60 transition">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a" alt="Case study" class="h-auto w-full hover:scale-110 transition duration-500" />
              </div>
              <div class="absolute left-1/2 top-1/2 flex h-[163px] w-[163px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-primary hover:scale-110 transition cursor-pointer">
                <span class="text-center text-lg font-bold leading-[126%] tracking-tight text-black">See Details</span>
              </div>
            </div>

            <!-- Card 2 - Ai Wave -->
            <div class="relative overflow-hidden rounded-[30px] border-[10px] border-white/30 backdrop-blur-[67px] hover:border-white/50 transition animate-fade-in hover:scale-105" style="animation-delay: 0.1s">
              <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a" alt="Ai Wave" class="h-full w-full object-cover hover:scale-110 transition duration-500" />
            ...
            <!-- Card 3 - App Lancer -->
            <div class="relative overflow-hidden rounded-[30px] border-[10px] border-white/30 backdrop-blur-[67px] hover:border-white/50 transition animate-fade-in hover:scale-105" style="animation-delay: 0.2s">
              <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a" alt="App Lancer" class="h-full w-full object-cover hover:scale-110 transition duration-500" />
              <div class="absolute left-8 top-8 flex items-center gap-3">
                <svg width="54" height="1" viewBox="0 0 54 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 0.5H54" stroke="white"/>
                </svg>
    ...
    <section class="bg-[#FAFAFA] px-5 py-16 md:px-20 md:py-20 animate-fade-in">
      <div class="mx-auto">
        <div class="flex flex-col gap-16">
          <blockquote class="text-center text-2xl font-medium leading-[180%] text-dark md:text-3xl lg:text-4xl">
            "{{ testimonials[currentTestimonial].text }}"
          </blockquote>

          <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div class="flex items-center gap-6">
              <div class="h-[70px] w-[70px] overflow-hidden rounded-full border-2 border-white/50 bg-black/20 hover:scale-110 transition"></div>
            ...
            <div class="flex items-center justify-center gap-10">
              <button class="flex items-center justify-center rounded-[70px] border border-dark p-4 transition hover:bg-dark hover:text-white hover:scale-110 active:scale-95">
              ...
              <span class="text-base font-semibold leading-[180%]">
                <span class="text-dark underline">01</span><span class="text-dark/40">/05</span>
              </span>
              <button class="flex items-center justify-center rounded-[70px] bg-dark p-4 transition hover:bg-dark/90 hover:scale-110 active:scale-95">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12 5L19 12L12 19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
          <div class="flex flex-col justify-center gap-12">
            ...
            <div class="flex flex-wrap gap-4">
              <button class="rounded-[70px] border border-dark px-8 py-4 text-base font-semibold leading-[180%] text-dark transition hover:bg-dark hover:text-white hover:scale-105 active:scale-95">
                More Questions
              </button>
          ...
          <div class="flex flex-col">
            <div 
              ...
              :key="index"
              class="border-b border-dark bg-white"
            >
              <button 
              ...
              >
                ...
                <svg 
                  ...
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 transition-transform duration-300"
                >
                ...
                <svg 
                  v-else
                  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 transition-transform duration-300 rotate-90"
                >
                  <path d="M5 12H19" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
      ...
      <div class="mx-auto">
        <div class="mb-16 flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
          ...
          <div class="flex flex-col justify-center gap-12">
            ...
            <button class="self-start rounded-[70px] border border-dark px-8 py-4 text-base font-semibold leading-[180%] text-dark transition hover:bg-dark hover:text-white hover:scale-105 active:scale-95">
              See more
            </button>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <!-- Card 1 -->
          <div class="flex flex-col gap-14 rounded-[20px] bg-white p-8 hover:shadow-xl transition hover:scale-105 animate-fade-in">
            <div class="flex flex-col gap-6">
              <div class="flex items-start justify-between">
                <div class="h-3.5 w-3.5 rounded-full bg-blue-accent animate-pulse"></div>
                <span class="text-sm font-medium leading-[160%] text-gray">5 min read</span>
              </div>
            ...
            <div class="flex items-center justify-between">
              <p class="max-w-[220px] overflow-hidden text-ellipsis whitespace-nowrap text-sm font-medium leading-[160%] text-gray">
                We are the top digital marketing agency for branding corp. We offer a full rang engine ....
              </p>
              <button class="flex h-[50px] w-[50px] flex-shrink-0 items-center justify-center rounded-full bg-dark transition hover:bg-dark/90 hover:scale-110 active:scale-95">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 12H19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12 5L19 12L12 19" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
          ...
          <!-- Card 2 -->
          <div class="flex flex-col gap-14 rounded-[20px] bg-white p-8 hover:shadow-xl transition hover:scale-105 animate-fade-in" style="animation-delay: 0.1s">
            <div class="flex flex-col gap-6">
              <div class="flex items-start justify-between">
                <div class="h-3.5 w-3.5 rounded-full bg-orange-accent animate-pulse" style="animation-delay: 0.2s"></div>
                <span class="text-sm font-medium leading-[160%] text-gray">5 min read</span>
              </div>
              <h3 class="text-2xl font-semibold leading-[150%] tracking-tight text-dark">
            ...
            <div class="flex items-center justify-between">
              ...
              <button class="flex h-[50px] w-[50px] flex-shrink-0 items-center justify-center rounded-full border border-dark transition hover:bg-dark hover:text-white hover:scale-110 active:scale-95">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Card 3 -->
          <div class="flex flex-col gap-14 rounded-[20px] bg-white p-8 hover:shadow-xl transition hover:scale-105 animate-fade-in" style="animation-delay: 0.2s">
            <div class="flex flex-col gap-6">
              <div class="flex items-start justify-between">
                <div class="h-3.5 w-3.5 rounded-full bg-purple-accent animate-pulse" style="animation-delay: 0.4s"></div>
                <span class="text-sm font-medium leading-[160%] text-gray">5 min read</span>
              </div>
              <h3 class="text-2xl font-semibold leading-[150%] tracking-tight text-dark">
    ...
    <section class="bg-[#FAFAFA] px-4 pb-16 md:px-5 md:pb-20">
      <div class="overflow-hidden rounded-[30px] bg-dark px-8 py-20 md:px-16 animate-fade-in hover:shadow-2xl transition">
        <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
          <h2 class="text-4xl font-semibold leading-[130%] tracking-tight text-white md:text-6xl lg:text-[80px]">
            Ready to work with us ?
          </h2>
          <button class="flex items-center gap-3 rounded-[50px] bg-white px-8 py-4 transition hover:bg-gray-lighter hover:scale-105 active:scale-95">
