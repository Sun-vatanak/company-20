  ...
  <div class="min-h-screen bg-white">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div class="flex flex-col justify-center gap-12 animate-fade-in">
            <div class="flex flex-col gap-8">
              ...
              <p
                class="max-w-[557px] text-base font-medium leading-[180%] text-gray animate-slide-down"
            ...
            <div
              class="flex flex-wrap items-center gap-8 md:gap-14 animate-slide-down"
            ...
            >
              ...
              >
                <span
                  class="font-manrope text-base font-bold leading-[140%] tracking-tight text-white"
                  >Explore us</span
                >
                <svg
                  width="24"
            ...
            <!-- Trusted brands -->
            <div
              class="flex flex-wrap items-center gap-8 md:gap-16 animate-slide-down"
            ...
            >
              ...
              <div class="flex items-center gap-7 opacity-50">
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/e7d50ae8a200300f69e8831be4c3ff9b006e51cd"
                  alt="Company logo"
                  class="h-8 w-auto hover:opacity-100 transition"
                />
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/e7d50ae8a200300f69e8831be4c3ff9b006e51cd"
                  alt="Company logo"
          ...
          <div class="relative flex flex-col justify-center gap-8 animate-slide-up">
            ...
            <div class="flex flex-col gap-8 md:flex-row md:items-start">
              <div
                class="w-full rounded-[20px_20px_20px_1000px] bg-gray-lighter/60 p-6 backdrop-blur-[42px] md:w-[303px] hover:shadow-lg transition"
              >
                <img
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a"
                  alt=""
                  class="h-auto w-full rounded-[1000px_20px_20px_20px]"
                />
              </div>
            ...
            >
              ...
              >
                <div class="flex flex-col gap-4">
                  ...
                  <h3
                    class="max-w-[280px] text-[32px] font-semibold leading-[130%] tracking-tight text-white"
                  >
                ...
                <div class="flex items-end gap-3">
                  <div
                    class="h-[95px] w-[69px] bg-[#BAE289] rounded-sm hover:scale-110 transition delay-100"
                  ></div>
                  <div
                    class="h-[136px] w-[69px] bg-[#99CF63] rounded-sm hover:scale-110 transition delay-200"
                  ></div>
                  <div
                    class="h-[166px] w-[69px] bg-[#77B248] rounded-sm hover:scale-110 transition delay-300"
                  ></div>
                </div>
              </div>
            ...
            <!-- 920+ card -->
            <div
              class="absolute -bottom-12 left-0 hidden rounded-[20px] bg-dark p-8 md:block lg:-bottom-20 animate-bounce-slow"
            >
              <div class="flex flex-col gap-6">
                <h2
                  class="text-6xl font-bold leading-[150%] tracking-[-0.03em] text-white lg:text-[84px]"
                >
                  920+
                </h2>
                ...
                <div class="flex items-center gap-2">
                  <div
                    class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"
                  ></div>
                  <div
                    class="h-[35px] w-[35px] rounded-full bg-[#C6C6C6] hover:scale-125 transition"
                  ></div>
    ...
    <section class="bg-white px-5 py-16 md:px-20 md:py-20 animate-fade-in">
      <div class="mx-auto">
        <div class="flex flex-col justify-between gap-12 lg:flex-row lg:items-start">
          <h2
            class="max-w-[684px] text-4xl font-semibold leading-[130%] tracking-tight text-dark md:text-5xl"
          >
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div class="rounded-[20px] bg-dark p-8 md:hidden lg:block hover:shadow-xl transition">
            <div class="flex flex-col gap-6">
              ...
              <div class="flex items-center gap-2">
                <div
                  class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"
                ></div>
                <div
                  class="h-[35px] w-[35px] rounded-full border-2 border-white/50 bg-[#C6C6C6] hover:scale-125 transition"
                ></div>
          ...
          <div class="relative overflow-hidden rounded-[30px] hover:shadow-2xl transition group">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/75a212ab82b6175c9862b125e0e23db8d369a58a"
              alt=""
              class="h-auto w-full object-cover group-hover:scale-110 transition duration-500"
            />
            <div
              class="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/40 transition"
            >
              <h3
                class="text-center text-3xl font-semibold leading-[140%] tracking-[0.27em] text-white md:text-5xl"
              >
                HOW WE WORK
              </h3>
            </div>
            <button
              class="absolute bottom-8 right-8 flex h-[163px] w-[163px] items-center justify-center rounded-full border-[12px] border-[#FAFAFA] bg-primary transition hover:scale-110 active:scale-95 shadow-xl group-hover:shadow-2xl"
            >
              <svg
                width="44"
                height="44"
        ...
        <div class="flex flex-col items-center gap-14">
          ...
          <div class="grid w-full grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative animate-fade-in hover:scale-105 transition">
              ...
              >
                <span class="text-center text-lg font-bold leading-[126%] tracking-tight text-black"
                  >See Details</span
                >
              </div>
            </div>
    ...
    <section class="bg-[#FAFAFA] px-5 py-16 md:px-20 md:py-20 animate-fade-in">
      <div class="mx-auto">
        <div class="flex flex-col gap-16">
          <blockquote
            class="text-center text-2xl font-medium leading-[180%] text-dark md:text-3xl lg:text-4xl"
          >
          ...
          <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div class="flex items-center gap-6">
              <div
                class="h-[70px] w-[70px] overflow-hidden rounded-full border-2 border-white/50 bg-black/20 hover:scale-110 transition"
              ></div>
            ...
            <div class="flex items-center justify-center gap-10">
              <button
                class="flex items-center justify-center rounded-[70px] border border-dark p-4 transition hover:bg-dark hover:text-white hover:scale-110 active:scale-95"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <button
                class="flex items-center justify-center rounded-[70px] bg-dark p-4 transition hover:bg-dark/90 hover:scale-110 active:scale-95"
              >
                <svg
                  width="24"
                  height="24"
        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-24">
          <div class="flex flex-col justify-center gap-12">
            ...
            <div class="flex flex-wrap gap-4">
              ...
              <button
                class="text-base font-semibold leading-[180%] text-dark underline hover:text-gray transition"
              >
                Contact Us
              </button>
            </div>
          ...
          <div class="flex flex-col">
            <div v-for="(faq, index) in faqs" :key="index" class="border-b border-dark bg-white">
              ...
              >
                <h3
                  class="max-w-[448px] text-xl font-semibold leading-[150%] tracking-tight text-dark md:text-2xl"
                >
                  {{ faq.question }}
                </h3>
                <svg
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  class="flex-shrink-0 transition-transform duration-300 rotate-90"
                >
                  <path
                    d="M5 12H19"
                    stroke="black"
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div class="flex items-center justify-between">
              ...
              >
                We are the top digital marketing agency for branding corp. We offer a full rang
                engine ....
              </p>
              <button
                class="flex h-[50px] w-[50px] flex-shrink-0 items-center justify-center rounded-full bg-dark transition hover:bg-dark/90 hover:scale-110 active:scale-95"
              >
                <svg
                  width="24"
                  height="24"
          ...
          >
            <div class="flex flex-col gap-6">
              <div class="flex items-start justify-between">
                <div
                  class="h-3.5 w-3.5 rounded-full bg-orange-accent animate-pulse"
                  style="animation-delay: 0.2s"
                ></div>
                <span class="text-sm font-medium leading-[160%] text-gray">5 min read</span>
              </div>
            ...
            <div class="flex items-center justify-between">
              <p
                class="max-w-[220px] overflow-hidden text-ellipsis whitespace-nowrap text-sm font-medium leading-[160%] text-gray"
              >
                Working with this digital marketing agency has been a true partnership. They have
                taken the time to understand our business and industry
              </p>
              <button
                class="flex h-[50px] w-[50px] flex-shrink-0 items-center justify-center rounded-full border border-dark transition hover:bg-dark hover:text-white hover:scale-110 active:scale-95"
              >
                <svg
                  width="24"
                  height="24"
          ...
          >
            <div class="flex flex-col gap-6">
              <div class="flex items-start justify-between">
                <div
                  class="h-3.5 w-3.5 rounded-full bg-purple-accent animate-pulse"
            ...
            <div class="flex items-center justify-between">
              ...
              >
                ...
                and collaboration. They keep us informed every step of the way,
              </p>
              <button
                class="flex h-[50px] w-[50px] flex-shrink-0 items-center justify-center rounded-full border border-dark transition hover:bg-dark hover:text-white hover:scale-110 active:scale-95"
              >
    ...
    <section class="bg-[#FAFAFA] px-4 pb-16 md:px-5 md:pb-20">
      ...
      >
        <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
          <h2
            class="text-4xl font-semibold leading-[130%] tracking-tight text-white md:text-6xl lg:text-[80px]"
          >
          ...
          >
            <span class="font-manrope text-base font-bold leading-[140%] tracking-tight text-dark"
              >Get Started</span
            >
            <svg
              width="24"
